...
!function(a, b) {
    ...
    function k(a) {
        ...
        !function() {
            ...
            !seajs.config({
                base : "/m/7.5/template/19",
                map: [[/^.*$/, function(url) {
                    return url += (url.indexOf('?') === -1 ? '?' : '&') + 'v=' + jsVer;
                }
                ]
                ]
            });
            /*! 初始化加载模块*/
            !seajs.use(["dist/js/app"], function(app) {
                app.init_modle();
            });
