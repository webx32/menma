define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./image", "./media", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery"], function(require, exports, module) {
    ...
    var i = function() {
        ...
        function p(t, e, n) {
            for (b in e) n && (o(e[b]) || G(e[b])) ? (o(e[b]) && !o(t[b]) && (t[b] = {}), G(e[b]) && !G(t[b]) && (t[b] = []), p(t[b], e[b], n)) : e[b] !== w && (t[b] = e[b])
        }
        ...
        return V.matches = function(t, e) {
            ...
            css: function(e, n) {
                ...
                if ("string" == t(e)) n || 0 === n ? r = c(e) + ":" + h(e, n) : this.each(function() {
                    ...
                    for (b in e) e[b] || 0 === e[b] ? r += c(b) + ":" + h(b, e[b]) + ";" : this.each(function() {
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var t = this.offsetParent || z.body; t && !L.test(t.nodeName) && "static" == C(t).css("position");) t = t.offsetParent;
                    return t
                })
            }
    ...
    function(t) {
        ...
        t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            var p, v = n.accepts[l],
                ...
                w = n.xhr(),
                b = w.setRequestHeader;
            if (a && a.promise(w), n.crossDomain || _("X-Requested-With", "XMLHttpRequest"), _("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && _("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers)
                ...
                return o.each(function() {
                    if ("" != this.name && "undefined" != this.name) {
                        var t = this.name,
                            ...
                            s = o.reg,
                            l = o.reg_tip;
                        if ("" == e.trim(e(this).val())) return a.showCheckMessage(n, r, !1), e(this).addClass("z-error"), i = !1, !1;
                        if (void 0 != s && "" != s && !e(this).val().match(s)) return e(this).addClass("z-error"), a.showCheckMessage(n, l, !1), i = !1, !1;
    ...
    var n = t("./Lottery"),
        ...
        r = {
            init: function() {
                ...
                var n = e("#j-mengban")[0],
                    a = "/template/19/img/page_01_bg@2x.jpg",
                    o = e("#r-cover").val(),
                    s = "image",
                    l = 640,
                    c = e(window).height(),
    ...
    function(t, e) {
        ...
        t.each(g, function(t, n) {
            ...
            var v, y, w, b = {},
                ...
                T = !1;
            if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i) b[u] = i, b[h] = a + "s", b[f] = m + "s", b[d] = p || "linear", S = t.fx.animationEnd;
            else {
                y = [];
                for (v in i) x.test(v) ? C += v + "(" + i[v] + ") " : (b[v] = i[v], y.push(n(v)));
